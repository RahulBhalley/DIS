...
if __name__ == "__main__":
    ...
    if hypar["mode"] == "train":
        ...
        hypar["restore_model"] = "./saved_models/isnet-general-use.pth" ## name of the segmentation model weights .pth for resume training process from last stop or for the inferencing
